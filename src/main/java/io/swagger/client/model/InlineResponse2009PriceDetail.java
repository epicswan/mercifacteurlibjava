...
public class InlineResponse2009PriceDetail {
  ...
  **/
  @Schema(description = "Montant total de l'affranchissement (ht, tva=0)")
   ...
   * @return letter
  **/
  @Schema(description = "Montant total du contenu lettres (ht, tva=tx standard)")
   ...
   * @return card
  **/
  @Schema(description = "Montant total du contenu cartes (ht, tva=tx standard)")
