...
public class MerciFacteur_Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(MerciFacteur_Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("MerciFacteur_Verticle started on port " + server.actualPort()));
      })
